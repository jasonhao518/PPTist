  ...
  layouts: [
    ...
    },
    {
      ...
      elements: [
        ...
        }, 
        {
          ...
          width: 585,
          height: 56,
          content: '<p style=\'text-align: center;\'><span style=\'font-size: 24px\'>在此处添加副标题11</span></p>',
          rotate: 0,
          defaultFontName: '{{fontName}}',
          defaultColor: '{{fontColor}}',
        }, 
    ...
    },
    {
      ...
      elements: [
        ...
        {
          type: 'placeholder',
          accept: ['image', 'paragraph', 'list'],
          groupId: 'images1',
          main: true,
          id: 'BO33Sv',
          left: 378.8888888888889,
          top: 335.24999999999994,
          width: 200.4444444444444,
          height: 230,
          rotate: 0,
          defaultFontName: '{{fontName}}',
          defaultColor: '{{fontColor}}',
    ...
    },
    {
      ...
      elements: [
        ...
        }, 
        {
          ...
          height: 120,
          content: '<ol>{{#toc}}<li>{{title}}</li>{{/toc}}</ol>',
          rotate: 0,
          defaultFontName: '{{fontName}}',
          defaultColor: '{{fontColor}}',
          fill: '{{subColor}}'
